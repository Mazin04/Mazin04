...
export function About() {
    ...
    return (
        <section id="About" className='px-10 lg:py-4 xl:mx-16 flex justify-center'>
            <div className='grid grid-cols-1 sm:grid-cols-12 px-0 mb:px-0'>
                <div className='col-span-12 lg:col-span-6 text-white mx-4 text-justify'>
                    <h1 className='text-5xl my-6 pb-4 border-b-4 lg:text-justify text-center'>About me</h1>
                    <div className='leading-10 text-left text-xl'>
                        ...
                        <p>I not only possess technical prowess but also value effective communication and collaboration. With near-native English proficiency certified at a C1 level, I can engage seamlessly in multicultural and multilingual work environments.</p>
                    </div>
                </div>
